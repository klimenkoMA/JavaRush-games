...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> framesList = new ArrayList<>();
        framesList.add(ShapeMatrix.FIRE_DOWN_1);
        framesList.add(ShapeMatrix.FIRE_DOWN_2);
        framesList.add(ShapeMatrix.FIRE_DOWN_3);
        downFire = new RocketFire(framesList);

        List<int[][]> leftFires = new ArrayList<>();
        leftFires.add(ShapeMatrix.FIRE_SIDE_1);
        leftFires.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(leftFires);

        List<int[][]> rightFires = new ArrayList<>();
        rightFires.add(ShapeMatrix.FIRE_SIDE_1);
        rightFires.add(ShapeMatrix.FIRE_SIDE_2);
        rightFire = new RocketFire(rightFires);
    }

    private void switchFire(boolean isUpPressed, boolean isLeftPressed,
